...
if __name__ == "__main__":
    txt_path = '/datasets/UCAS-AOD/PLANE'
    xml_path = '/datasets/UCAS-AOD/label-xml'
    scr_img_path = '/datasets/UCAS-AOD/PLANE'
    img_path = '/datasets/UCAS-AOD/images'
    ...
    for count, t in enumerate(txts):
        ...
        shutil.copy(os.path.join(scr_img_path, img_name), os.path.join(img_path, 'plane_' + img_name))
        h, w, d = img.shape
        WriterXMLFiles('plane_' + xml_name, xml_path, boxes, labels, w, h, d)
